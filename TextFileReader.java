...
public class TextFileReader
{
    ...
    TextFileReader(String filePath) throws FileNotFoundException
    {
    ...
    //same as readLineOmit, but operates on indices of lines specified in input array
    public String[][] readLineOmit(int[] lineIndex, String omitted) throws IOException
    {
        String[][] temp = new String[lineIndex.length][];

        return null;
    }

    private static void omitHelper()
    {
